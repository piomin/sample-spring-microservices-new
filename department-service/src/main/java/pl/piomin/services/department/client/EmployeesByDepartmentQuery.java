...
public final class EmployeesByDepartmentQuery implements Query<EmployeesByDepartmentQuery.Data, EmployeesByDepartmentQuery.Data, EmployeesByDepartmentQuery.Variables> {
  ...
  public static final String OPERATION_ID = "14971a7245ab04844941749beef351913563d71c03d8a05a48ca6375230e90aa";
  ...
  public static class EmployeesByDepartment {
    static final ResponseField[] $responseFields = {
      ...
      ResponseField.forInt("salary", "salary", null, false, Collections.<ResponseField.Condition>emptyList())
    };
    ...
    public EmployeesByDepartment(@NotNull String __typename, @NotNull String id,
        @NotNull String name, @NotNull String position, int salary) {
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          ...
          writer.writeString($responseFields[3], position);
          writer.writeInt($responseFields[4], salary);
        }
      };
    }
    ...
    public static final class Mapper implements ResponseFieldMapper<EmployeesByDepartment> {
      ...
      public EmployeesByDepartment map(ResponseReader reader) {
        ...
        final String position = reader.readString($responseFields[3]);
        final int salary = reader.readInt($responseFields[4]);
        return new EmployeesByDepartment(__typename, id, name, position, salary);
      }
    }
  }
}
